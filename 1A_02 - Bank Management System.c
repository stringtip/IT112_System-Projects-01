...
int main()
{
   ...
   printf("\t\t\4\t\t\t\t\t\t\4\n");
   printf("\t\t\4\t\t\t\t\t\t\4\n");
   printf("\t\t\4\tWELCOME TO OUR MA BANKING SYSTEM\t\t\4\n");
   printf("\t\t\4\t\t\t\t\t\t\4\n");
   printf("\t\t\4\t\t\t\t\t\t\4\n");
printf("\t\t\4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4 \4\n");
...
if(dep > 0 && dep<=20000)
{
printf("\nyour %.2fPhp deposited in your account.\n\n",dep);
balance+=dep;
}
else if(dep>20000)
{
...
if(balance>=transfer)
{
printf("\nyour %.2fPhps successfully transfered\n\n",transfer);
balance-=transfer;
}
else
...
printf("\n\t\t\t\tMA BANK LIMITED\n");
printf("\t\t\t    -----------------------\n\n");
printf("\t\t\tDate:10/22/03\t   Time:5:44 PM\n");
printf("\n\t\t\t\4 Your name: %s\n\n",name);
...
{printf("\t\t\t\4 You've deposited 0Php\n");}
if(draw>0 && draw<=20000 && draw<=balance)
{
printf("\t\t\t\4 You've withdraw %.2fPhp\n",draw);
}
else
{printf("\t\t\t\4 You've withdraw 0Php\n");}
if(transfer>0 && transfer<=20000 && transfer<=balance)
{
printf("\t\t\t\4 You've Transfered %.2fPhp\n",transfer);}
else
{printf("You've Transfered 0Php\n ");}
printf("\n\t\t\t\t    Thank you for Using MA BANK! \n");
getch();
return(0);
}